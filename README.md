...
|---|---|
| 🧑‍✈️ **Hoàng Văn Thái** | **Quản lý Nhân viên** (CRUD, tìm kiếm/lọc); **Quản lý Phòng ban & Chức vụ** (CRUD, liên kết nhân viên); tham gia thiết kế & xây dựng giao diện các màn hình. |
| 👨‍💻 **Đặng Xuân Trường** | **Chấm công** theo ngày (thêm/sửa/xóa, lọc theo ngày/phòng ban); **Database** (thiết kế CSDL, tạo bảng, PK/FK, dữ liệu mẫu, script SQL); hỗ trợ kết nối JDBC/DAO. |
